...
public class NewShapeBridge {
	...
	private Shape shape;
	private NewHeroType role;
	private PlayerType player;
	private int size;
	public NewShapeBridge(int size, PlayerType p, NewHeroType r){
		this.role = r;
		this.size = size;
		this.player = p;
	}
